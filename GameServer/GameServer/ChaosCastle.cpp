...
int CChaosCastle::GetRemainTimeSec(int level)
{
	if (CC_LEVEL_RANGE(level) == 0)
	{
		return 0;
	...
	for (std::vector<CHAOS_CASTLE_START_TIME>::iterator it = this->m_ChaosCastleStartTime.begin();
		it != this->m_ChaosCastleStartTime.end(); it++)
	{
