...
BOOL InitInstance(HINSTANCE hInstance,int nCmdShow) // OK
{
    ...
    // fereastră normală, dar întinsă pe tot ecranul (păstrezi meniul)
    hWnd = CreateWindow(
        szWindowClass,
        szTitle,
		...
		case WM_COMMAND:
			switch(LOWORD(wParam))
			{
				...
				case IDM_RELOAD_RELOADUTIL:
					...
					break;
				case ID_RELOAD_RELOADINVASIONS:
					gInvasionManager.ReloadInvasions();
					break;
				case ID_EVENTSTART_GOLDENINVASION:
					gInvasionManager.StartInvasionManual(INV_GOLDEN_MONSTER);
					break;
				case ID_EVENTSTART_SKELETONKING:
					gInvasionManager.StartInvasionManual(INV_SKELETON_KING);
					break;
				case ID_EVENTSTART_WHITEWIZARD:
					gInvasionManager.StartInvasionManual(INV_WHITE_WIZARD);
					break;
				case ID_EVENTSTART_REDDRAGON:
					gInvasionManager.StartInvasionManual(INV_FIRE_DRAGON);
					break;
				case ID_EVENTSTART_MEDUSA:
					gInvasionManager.StartInvasionManual(INV_MEDUSA);
					break;
				case ID_EVENTS_RELOADBC:
					gServerInfo.ReloadBC();
					break;
				case ID_EVENTS_RELOADDS:
					gServerInfo.ReloadDS();
					break;
				case ID_EVENTS_RELOADCC:
					gServerInfo.ReloadCC();
					break;
				case ID_CUSTOM_MONSTERSTATS:
					gServerInfo.ReloadMonsterStats();
					break;
				default:
