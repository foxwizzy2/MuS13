...
int CBloodCastle::GetRemainTimeSec(int level)
{
	if (BC_LEVEL_RANGE(level) == 0)
	{
		return 0;
	...
	for (std::vector<BLOOD_CASTLE_START_TIME>::iterator it = this->m_BloodCastleStartTime.begin();
		it != this->m_BloodCastleStartTime.end(); it++)
	{
