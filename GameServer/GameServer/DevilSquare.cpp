...
int CDevilSquare::GetRemainTimeSec(int level)
{
	if (DS_LEVEL_RANGE(level) == 0)
	{
		return 0;
	...
	for (std::vector<DEVIL_SQUARE_START_TIME>::iterator it = this->m_DevilSquareStartTime.begin();
		it != this->m_DevilSquareStartTime.end(); it++)
	{
